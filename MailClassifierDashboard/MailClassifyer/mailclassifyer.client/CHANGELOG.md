...
- Create Angular project with ng: `ng new mailclassifyer.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`mailclassifyer.client.esproj`).
